    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8 max-w-4xl">
        <div className="prose prose-lg max-w-none">
          <h1 className="text-3xl font-bold mb-8">Reslo Terms of Use</h1>
          ...
          <div className="mb-8">
            <p className="text-lg">
              Welcome to Reslo! These Terms of Use ("Terms") form a binding legal agreement between you ("User" or "you") and Reslo AI LLC, a Florida limited liability company ("Reslo," "we," or "us"), governing your access to and use of our web-based services for resume optimization and AI-generated content (the "Service").
            </p>
            <p className="mt-4">
          ...
          <section className="mb-8">
            ...
            <p className="mt-4">
              Reslo reserves the right to block, restrict, or remove any prompts, inputs, or outputs that violate this Code of Conduct, and to suspend or terminate any account for serious or repeated violations.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>Grant Reslo a perpetual, worldwide, irrevocable, royalty-free license to store, use, reproduce, modify, and distribute both your Inputs and Outputs for purposes including model improvement, research, analytics, and marketing;</li>
              <li>Acknowledge that Outputs may not be unique, and that similar or identical results may be generated for other users;</li>
              <li>Understand that Reslo does not verify the factual accuracy, originality, or legality of any Output.</li>
            </ul>
            <p className="mt-4">
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              All features, templates, software, and design elements of the Service are the exclusive property of Reslo or its licensors and are protected by U.S. and international copyright, trademark, and trade secret laws.
            </p>
            <p>
              Reslo grants you a limited, non-transferable, revocable license to use the Service and your AI-generated resume content for personal use. You may not reproduce, distribute, or modify any part of the Service without Reslo's written permission.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Reslo does not guarantee the accuracy, uniqueness, or effectiveness of any resume or Output;</li>
          ...
          <section className="mb-8">
            ...
            <p>
              If you provide Reslo with any feedback, testimonials, feature suggestions, or related content, you grant us a non-exclusive, perpetual, royalty-free license to use, publish, and display such content in any media without restriction or compensation.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="font-semibold mb-4">
              THE SERVICE IS PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF ANY KIND. Reslo DISCLAIMS ALL EXPRESS OR IMPLIED WARRANTIES, INCLUDING BUT NOT LIMITED TO MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT.
            </p>
            <p className="font-semibold">
              Reslo DOES NOT WARRANT THAT THE SERVICE WILL BE UNINTERRUPTED, ERROR-FREE, OR FREE OF MALICIOUS CODE.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="font-semibold mb-4">
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, Reslo AND ITS AFFILIATES SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, CONSEQUENTIAL, SPECIAL, OR EXEMPLARY DAMAGES ARISING OUT OF OR RELATED TO YOUR USE OF THE SERVICE, INCLUDING LOSS OF DATA, LOSS OF PROFITS, OR EMPLOYMENT OPPORTUNITY.
            </p>
            <p className="font-semibold">
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">You agree to defend, indemnify, and hold harmless Reslo, its officers, affiliates, contractors, and agents from any claims, liabilities, damages, or expenses (including attorneys' fees) arising from:</p>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              If you reside in the United States, you agree to resolve any disputes with Reslo through binding arbitration conducted in Tampa, Florida, under the rules of the American Arbitration Association.
            </p>
            <p>
