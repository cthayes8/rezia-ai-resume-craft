        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-rezia-blue">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-600 hover:text-rezia-blue">Updates</a></li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="tel:+15551234567" className="text-gray-600 hover:text-rezia-blue flex items-center">
